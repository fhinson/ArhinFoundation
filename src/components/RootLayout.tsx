        ...
        <div className="flex items-center gap-x-8">
          ...
          <button
            ...
            className={clsx(
              ...
              invert ? 'hover:bg-ivory/10' : 'hover:bg-fg/10',
            )}
            ...
            <Icon
              className={clsx(
                ...
                invert
                  ...
                  : 'fill-slate-900 group-hover:fill-slate-700',
              )}
            />
          </button>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full mask-[linear-gradient(to_bottom_left,white_40%,transparent_50%)] fill-slate-50 stroke-slate-900/5"
            yOffset={-96}
            interactive
          />
